...
const items = [
    ...
    },
    {
        ...
        descripcion:
            "Catálogo de productos con carrito de compras, permite a los usuarios gestionar productos. Utiliza Supabase para la gestión de datos y generación automática de páginas por producto agregado.",
        imagen: "/Screenshot_WEB_2.webp",
        demo: "https://tienda-perfumes.vercel.app/",
    ...
    },
    {
        ...
        descripcion:
            "Proyecto universitario que consiste en una web de consultoría para la FIEI. Incluye formulario de contacto, blog, galería de imágenes y diseño responsive.",
        imagen: "/Screenshot_WEB_3.webp",
        demo: "https://proyecto-gerencia.vercel.app/",
        repositorio: "https://github.com/Marco-Silvera/ProyectoGerencia",
        path: "/proyecto-3",
        color: "#C2491D",
        bullets: [
    ...
    },
    {
        ...
        nombre: "Aluraflix",
        descripcion:
            "Proyecto de Alura ONE (Oracle Next Education), el cual busca replicar la interfaz de Netflix. Incluye secciones y permitr agregar, editar y eliminar películas.",
        imagen: "/Screenshot_WEB_4.webp",
    ...
    },
    {
        ...
        descripcion:
            "Proyecto de 50 días con 50 proyectos de HTML, CSS y JavaScript. Incluye proyectos de animaciones, efectos, diseños y funcionalidades.",
        imagen: "/Screenshot_WEB_5.webp",
...
export default function ProjectList() {
    ...
    return (
        <div
            id="proyectos"
            className="w-full flex flex-col justify-center items-center bg-fixed bg-no-repeat bg-cover bg-center scroll-mt-[62px] gap-10"
        >
            <h2 className="top-[50px] lg:top-[100px] relative text-xl md:text-2xl lg:text-4xl w-fit bg-gradient-to-r from-[#9898A6] to-[#fdfdfe] text-transparent bg-clip-text uppercase font-normal tracking-[.96px]">
                Proyectos
            </h2>
            <section
                ref={container}
                ...
                {items.map((item, i) => {
                    ...
                    return (
                        <Card
                            ...
                            ref={i === items.length - 1 ? lastCard : null}
                        />
                    );
                })}
            </section>

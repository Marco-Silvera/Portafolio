...
const Section2 = () => {
    return (
        <div className="flex justify-between items-end">
            <h1 className="text-[8vw] md:text-[10vw] leading-[0.8] font-after-sick">
                Marco Silvera
            </h1>
        ...
        <div className="flex w-full justify-center md:justify-end">
            <ul className="flex gap-5 sm:gap-10 justify-between sm:justify-center h-full w-full max-w-[300px] min-w-[200px]">
                ...
                <li className="group relative inline-block h-full">
                    <a
                        className="focus:outline-none cursor-pointer"
                        href="mailto:msilveradev@gmail.com"
                ...
                {/* <li className="group relative inline-block h-full">
                    <a className="focus:outline-none cursor-pointer" href="https://www.instagram.com/marko_silvera/" target="_blank">
                        <svg
                            viewBox="0 0 16 16"
                            fill="#212121"
                            height="20"
